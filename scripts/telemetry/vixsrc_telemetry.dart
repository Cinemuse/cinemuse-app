...
void main() async {
    ...
    try {
      ...
      if (candidates.isNotEmpty) {
        ...
        try {
          ...
          final playlistRes = await dio.get(
            urlStr,
            options: Options(headers: c.headers),
          );
          ...
          if (subMatches.isNotEmpty) {
            ...
            if (subRes.statusCode == 200) {
              ...
              final segmentLine = subPlaylistContent
                  .split('\n')
                  .firstWhere(
              ...
              if (segmentLine.isNotEmpty) {
                ...
                if (segRes.statusCode == 200) {
                  ...
                  final segData = segRes.data is String
                      ? segRes.data as String
                      : 'Binary data';
  ...
  if (stepSummaryPath != null) {
    ...
    sink.writeln('\n#### Test Results');
    sink.writeln(
      '| Title | Status | Candidates | Languages | Subtitles | Notes |',
    );
    sink.writeln('| :--- | :--- | :--- | :--- | :--- | :--- |');
    ...
    for (final entry in results.entries) {
      ...
      final subTest = data['subtitle_test'] == 'PASSED'
          ? '✅'
          : '❌ (${data['subtitle_error']})';
      ...
      sink.writeln(
        '| **$title** | $statusIcon ${data['status']} | $candidates | $langs | $subTest | $notes |',
      );
    }
